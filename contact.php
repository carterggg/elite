...
<title>Elite Remodeling Atlanta LLC</title>
   				...
   				<ul> <br><br><br>
   					...
   					<li class="mobile-main-nav li-mobile-style"><a href="#">SERVICES</a></li>
   							<ul class="mobile-dropdown-nav">
								...
								<li class="dropdown-mobile-size"><a href="realestateagents.html">- REAL ESTATE AGENTS</a></li>
								<li class="dropdown-mobile-size"><a href="investors.html">- INVESTORS</a></li>
   							</ul>
...
<!-- Footer Nav -->				
				<nav class="nav-footer align-center">
					<ul>
						...
						<li><a href="about.html" title="Elite Remodeling Atlanta LLC">About Us</a></li>
						<li><a href="contact.php" title="Elite Remodeling Atlanta LLC">Contact</a></li>
						<li><a href="careers.html" title="Elite Remodeling Atlanta LLC">Careers</a></li>
					</ul>
				</nav>
				<br>
